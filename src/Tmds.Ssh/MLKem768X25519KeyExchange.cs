...
sealed class MLKem768X25519KeyExchange : Curve25519KeyExchange
{
    ...
    private byte[] GenerateHybridPublicKey(out MLKem? mlKem, out AsymmetricCipherKeyPair? mlkem768KeyPair, out ECCurve curve, out ECDiffieHellman? myECDH, out AsymmetricCipherKeyPair? x25519KeyPair)
    {
        mlKem = null;
        mlkem768KeyPair = null;
        ...
        var x25519PublicKey = GeneratePublicKey(out curve, out myECDH, out x25519KeyPair);
    ...
    private byte[] DeriveHybridRawSecretAgreement(MLKem? mlkem, AsymmetricCipherKeyPair? mlkem768KeyPair, ECCurve curve, ECDiffieHellman? ecdh, AsymmetricCipherKeyPair? x25519KeyPair, byte[] s_reply)
    {
        ...
        var x25519Agreement = DeriveRawSecretAgreement(curve, ecdh, x25519KeyPair, s_reply.AsSpan(_mlKemAlgorithm.CiphertextSizeInBytes));
